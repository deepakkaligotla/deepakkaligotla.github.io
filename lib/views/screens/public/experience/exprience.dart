...
class _ExperienceScreen extends State<ExperienceScreen> {
  ...
  void initState() {
    ...
    Future.microtask(
      () =>
          Provider.of<ExperienceViewModel>(
            context,
            listen: false,
          ).fetchExperiences(),
    );
  ...
  Widget _buildExperienceCard({
    ...
    required FinalModel finalData
  }) {
    // Convert the timestamp to a human-readable date string
    String formattedDateOfJoining = _formatDate(dateOfJoining);
    String formattedLastWorkingDay =
        lastWorkingDay != null ? _formatDate(lastWorkingDay) : "Present";
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          fontSize: 18,
                          color: finalData.userDetails.userColorScheme!.onSurfaceVariant,
                        ),
                      ),
                      Text(
                        companyName,
                        style: TextStyle(
                          ...
                          fontSize: 20,
                          color: finalData.userDetails.userColorScheme!.onSurface,
                        ),
                      ),
                      Text(
                        roleDescription,
                        style: TextStyle(
                          fontSize: 14,
                          color: finalData.userDetails.userColorScheme!.error,
                        ),
                      ),
                      Row(
                        children: [
